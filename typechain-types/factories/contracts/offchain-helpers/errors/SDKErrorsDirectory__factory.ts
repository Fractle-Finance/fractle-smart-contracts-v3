...
} from "../../../../contracts/offchain-helpers/errors/SDKErrorsDirectory";
...
const _bytecode =
  "";
...
export class SDKErrorsDirectory__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): SDKErrorsDirectory__factory {
    return super.connect(runner) as SDKErrorsDirectory__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SDKErrorsDirectoryInterface {
    return new Interface(_abi) as SDKErrorsDirectoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SDKErrorsDirectory {
    return new Contract(address, _abi, runner) as unknown as SDKErrorsDirectory;
  }
}
