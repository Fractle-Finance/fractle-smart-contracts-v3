...
} from "../../../contracts/interfaces/IPRouterStatic";
...
export class IPRouterStatic__factory {
  ...
  static createInterface(): IPRouterStaticInterface {
    return new Interface(_abi) as IPRouterStaticInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPRouterStatic {
    return new Contract(address, _abi, runner) as unknown as IPRouterStatic;
  }
}
