...
export interface PtAndLpToAssetInterface extends Interface {
  getFunction(
    nameOrSignature: "getLpToAssetRate" | "getPtToAssetRate"
  ): FunctionFragment;
...
export interface PtAndLpToAsset extends BaseContract {
  connect(runner?: ContractRunner | null): PtAndLpToAsset;
  waitForDeployment(): Promise<this>;

  interface: PtAndLpToAssetInterface;
