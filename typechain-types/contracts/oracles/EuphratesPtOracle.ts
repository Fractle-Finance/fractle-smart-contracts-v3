...
export interface EuphratesPtOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface EuphratesPtOracle extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesPtOracle;
  waitForDeployment(): Promise<this>;

  interface: EuphratesPtOracleInterface;
