...
export interface IPActionMintRedeemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "mintPyFromSy"
      | "mintPyFromToken"
...
export interface IPActionMintRedeem extends BaseContract {
  connect(runner?: ContractRunner | null): IPActionMintRedeem;
  waitForDeployment(): Promise<this>;

  interface: IPActionMintRedeemInterface;
