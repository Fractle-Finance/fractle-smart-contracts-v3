...
export interface IPYieldTokenV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "PT"
      | "SY"
...
export interface IPYieldTokenV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IPYieldTokenV3;
  waitForDeployment(): Promise<this>;

  interface: IPYieldTokenV3Interface;
