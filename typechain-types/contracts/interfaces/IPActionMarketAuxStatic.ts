...
export interface IPActionMarketAuxStaticInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "calcPriceImpactPY"
      | "calcPriceImpactPt"
...
export interface IPActionMarketAuxStatic extends BaseContract {
  connect(runner?: ContractRunner | null): IPActionMarketAuxStatic;
  waitForDeployment(): Promise<this>;

  interface: IPActionMarketAuxStaticInterface;
