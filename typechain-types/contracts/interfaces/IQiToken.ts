...
export interface IQiTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IQiToken extends BaseContract {
  connect(runner?: ContractRunner | null): IQiToken;
  waitForDeployment(): Promise<this>;

  interface: IQiTokenInterface;
