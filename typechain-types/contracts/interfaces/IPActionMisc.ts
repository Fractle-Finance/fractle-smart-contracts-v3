...
export interface IPActionMiscInterface extends Interface {
...
export interface IPActionMisc extends BaseContract {
  connect(runner?: ContractRunner | null): IPActionMisc;
  waitForDeployment(): Promise<this>;

  interface: IPActionMiscInterface;
