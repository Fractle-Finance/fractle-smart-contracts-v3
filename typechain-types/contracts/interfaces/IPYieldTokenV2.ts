...
export interface IPYieldTokenV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "PT"
      | "SY"
...
export interface IPYieldTokenV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IPYieldTokenV2;
  waitForDeployment(): Promise<this>;

  interface: IPYieldTokenV2Interface;
