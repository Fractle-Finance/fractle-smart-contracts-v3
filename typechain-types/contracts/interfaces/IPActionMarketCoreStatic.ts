...
export interface IPActionMarketCoreStaticInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IPActionMarketCoreStatic extends BaseContract {
  connect(runner?: ContractRunner | null): IPActionMarketCoreStatic;
  waitForDeployment(): Promise<this>;

  interface: IPActionMarketCoreStaticInterface;
