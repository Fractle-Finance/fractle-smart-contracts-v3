...
export interface IQiErc20Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IQiErc20 extends BaseContract {
  connect(runner?: ContractRunner | null): IQiErc20;
  waitForDeployment(): Promise<this>;

  interface: IQiErc20Interface;
