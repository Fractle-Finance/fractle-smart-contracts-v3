...
export interface EuphratesYieldTokenV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "PT"
      | "SY"
...
export interface EuphratesYieldTokenV2 extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesYieldTokenV2;
  waitForDeployment(): Promise<this>;

  interface: EuphratesYieldTokenV2Interface;
