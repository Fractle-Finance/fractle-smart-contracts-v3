...
export interface EuphratesYieldContractFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claimOwnership"
      | "createYieldContract"
  ...
  encodeFunctionData(
    functionFragment: "createYieldContract",
  ...
  encodeFunctionData(
    functionFragment: "ytCreationCodeContractA",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "ytCreationCodeContractB",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "ytCreationCodeSizeA",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "ytCreationCodeSizeB",
    values?: undefined
  ): string;
...
export interface EuphratesYieldContractFactory extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesYieldContractFactory;
  waitForDeployment(): Promise<this>;

  interface: EuphratesYieldContractFactoryInterface;
  ...
  createYieldContract: TypedContractMethod<
    [SY: AddressLike, expiry: BigNumberish, doCacheIndexSameBlock: boolean],
  ...
  ytCreationCodeContractA: TypedContractMethod<[], [string], "view">;

  ytCreationCodeContractB: TypedContractMethod<[], [string], "view">;

  ytCreationCodeSizeA: TypedContractMethod<[], [bigint], "view">;

  ytCreationCodeSizeB: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "createYieldContract"
  ): TypedContractMethod<
    [SY: AddressLike, expiry: BigNumberish, doCacheIndexSameBlock: boolean],
    [[string, string] & { PT: string; YT: string }],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "ytCreationCodeContractA"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "ytCreationCodeContractB"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "ytCreationCodeSizeA"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "ytCreationCodeSizeB"
  ): TypedContractMethod<[], [bigint], "view">;
