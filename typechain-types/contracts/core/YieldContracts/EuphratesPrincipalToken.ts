...
export interface EuphratesPrincipalTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "SY"
...
export interface EuphratesPrincipalToken extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesPrincipalToken;
  waitForDeployment(): Promise<this>;

  interface: EuphratesPrincipalTokenInterface;
