...
export interface EuphratesMarketV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "_storage"
      | "activeBalance"
...
export interface EuphratesMarketV2 extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesMarketV2;
  waitForDeployment(): Promise<this>;

  interface: EuphratesMarketV2Interface;
