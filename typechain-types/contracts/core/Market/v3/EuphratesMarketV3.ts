...
export interface EuphratesMarketV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "_storage"
      | "activeBalance"
  ...
  encodeFunctionData(
    functionFragment: "initialAnchor",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "scalarRoot", data: BytesLike): Result;
...
export interface EuphratesMarketV3 extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesMarketV3;
  waitForDeployment(): Promise<this>;

  interface: EuphratesMarketV3Interface;
  ...
  initialAnchor: TypedContractMethod<[], [bigint], "view">;
  ...
  scalarRoot: TypedContractMethod<[], [bigint], "view">;
