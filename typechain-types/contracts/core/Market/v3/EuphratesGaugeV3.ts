...
export interface EuphratesGaugeV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "activeBalance"
      | "lastRewardBlock"
...
export interface EuphratesGaugeV3 extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesGaugeV3;
  waitForDeployment(): Promise<this>;

  interface: EuphratesGaugeV3Interface;
