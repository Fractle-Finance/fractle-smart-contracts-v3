...
export interface EuphratesEUSDSYInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "accruedRewards"
  ...
  encodeFunctionData(functionFragment: "eUSD", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "eUSD", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "eip712Domain",
    data: BytesLike
  ): Result;
...
export interface EuphratesEUSDSY extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesEUSDSY;
  waitForDeployment(): Promise<this>;

  interface: EuphratesEUSDSYInterface;
  ...
  eUSD: TypedContractMethod<[], [string], "view">;
