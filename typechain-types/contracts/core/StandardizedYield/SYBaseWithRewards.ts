...
export interface SYBaseWithRewardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "accruedRewards"
...
export interface SYBaseWithRewards extends BaseContract {
  connect(runner?: ContractRunner | null): SYBaseWithRewards;
  waitForDeployment(): Promise<this>;

  interface: SYBaseWithRewardsInterface;
