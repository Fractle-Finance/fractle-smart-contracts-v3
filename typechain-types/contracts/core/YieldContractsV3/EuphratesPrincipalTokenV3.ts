...
export interface EuphratesPrincipalTokenV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "SY"
  ...
  encodeFunctionData(
    functionFragment: "redeemInterest",
...
export namespace RedeemInterestFPTEvent {
...
export interface EuphratesPrincipalTokenV3 extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesPrincipalTokenV3;
  waitForDeployment(): Promise<this>;

  interface: EuphratesPrincipalTokenV3Interface;
  ...
  redeemInterest: TypedContractMethod<
    [user: AddressLike, redeemInterest: boolean],
    [bigint],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "redeemInterest"
  ): TypedContractMethod<
    [user: AddressLike, redeemInterest: boolean],
    [bigint],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "RedeemInterestFPT"
  ): TypedContractEvent<
    RedeemInterestFPTEvent.InputTuple,
    RedeemInterestFPTEvent.OutputTuple,
    RedeemInterestFPTEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "RedeemInterestFPT(address,uint256)": TypedContractEvent<
      RedeemInterestFPTEvent.InputTuple,
      RedeemInterestFPTEvent.OutputTuple,
      RedeemInterestFPTEvent.OutputObject
    >;
    RedeemInterestFPT: TypedContractEvent<
      RedeemInterestFPTEvent.InputTuple,
      RedeemInterestFPTEvent.OutputTuple,
      RedeemInterestFPTEvent.OutputObject
    >;
