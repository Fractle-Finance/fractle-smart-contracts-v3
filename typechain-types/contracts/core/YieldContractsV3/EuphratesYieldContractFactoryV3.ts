...
export interface EuphratesYieldContractFactoryV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "claimOwnership"
      | "expiryDivisor"
...
export interface EuphratesYieldContractFactoryV3 extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesYieldContractFactoryV3;
  waitForDeployment(): Promise<this>;

  interface: EuphratesYieldContractFactoryV3Interface;
