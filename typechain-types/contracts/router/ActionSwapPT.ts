...
export interface ActionSwapPTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "swapExactPtForSy"
      | "swapExactPtForToken"
...
export interface ActionSwapPT extends BaseContract {
  connect(runner?: ContractRunner | null): ActionSwapPT;
  waitForDeployment(): Promise<this>;

  interface: ActionSwapPTInterface;
