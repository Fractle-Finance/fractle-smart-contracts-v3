...
export interface EuphratesRouterHelperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ROUTER"
      | "WETH"
  ...
  encodeFunctionData(
    functionFragment: "addLiquiditySingleTokenKeepYtWithEth",
    values: [
      AddressLike,
      AddressLike,
      BigNumberish,
...
export interface EuphratesRouterHelper extends BaseContract {
  connect(runner?: ContractRunner | null): EuphratesRouterHelper;
  waitForDeployment(): Promise<this>;

  interface: EuphratesRouterHelperInterface;
  ...
  addLiquiditySingleTokenKeepYtWithEth: TypedContractMethod<
    [
      receiver: AddressLike,
      market: AddressLike,
      minLpOut: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "addLiquiditySingleTokenKeepYtWithEth"
  ): TypedContractMethod<
    [
      receiver: AddressLike,
      market: AddressLike,
