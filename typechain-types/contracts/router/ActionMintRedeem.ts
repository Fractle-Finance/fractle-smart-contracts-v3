...
export interface ActionMintRedeemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "mintPyFromSy"
      | "mintPyFromToken"
...
export interface ActionMintRedeem extends BaseContract {
  connect(runner?: ContractRunner | null): ActionMintRedeem;
  waitForDeployment(): Promise<this>;

  interface: ActionMintRedeemInterface;
