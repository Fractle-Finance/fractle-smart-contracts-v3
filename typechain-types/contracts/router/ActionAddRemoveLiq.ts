...
export interface ActionAddRemoveLiqInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ActionAddRemoveLiq extends BaseContract {
  connect(runner?: ContractRunner | null): ActionAddRemoveLiq;
  waitForDeployment(): Promise<this>;

  interface: ActionAddRemoveLiqInterface;
