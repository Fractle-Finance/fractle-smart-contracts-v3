...
import "./InterestManagerYTV3.sol";
...
*/
contract EuphratesYieldTokenV3 is
    IPYieldTokenV3,
    EuphratesERC20,
    RewardManager,
    InterestManagerYTV3
{
    ...
    modifier onlyPT() {
        if (msg.sender != PT) revert Errors.OnlyPT();
        _;
    }
    ...
    function updateSyReserve() external onlyPT {
        _updateSyReserve();
    }
    ...
    function updateAndDistributeInterestFPT(address user) external onlyPT {
