...
contract EuphratesMarketV2 is EuphratesERC20, EuphratesGaugeV2, IPMarket {
    ...
    string private constant NAME = "Euphrates Market";
    string private constant SYMBOL = "EUPHRATES-LPT";
    ...
    /**
     * @notice EuphratesMarket allows users to provide in PT & SY in exchange for LPs, which
    ...
    /**
     * @notice Euphrates Market allows swaps between PT & SY it is holding. This function
