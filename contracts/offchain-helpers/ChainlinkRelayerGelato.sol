...
import "../core/StandardizedYield/implementations/ChainlinkRelayer/EuphratesChainlinkRelayer.sol";

contract ChainlinkRelayerGelato is AutomateReady, BoringOwnableUpgradeable {
    EuphratesChainlinkRelayer public immutable relayer;

    int256 public lastSentAnswer;

    constructor(address _automate, address _taskCreator, EuphratesChainlinkRelayer _relayer) initializer
