...
import "./EuphratesPtOracleLib.sol";
import "../interfaces/IPPtOracle.sol";
import "../core/libraries/BoringOwnableUpgradeable.sol";

contract EuphratesPtOracle is BoringOwnableUpgradeable, IPPtOracle {
    using EuphratesPtOracleLib for IPMarket;

    error InvalidBlockRate(uint256 blockCycleNumerator);
    error TwapDurationTooLarge(uint32 duration, uint32 cardinalityRequired);

    /// @notice Oracles will be created ensuring a lowerbound in EuphratesMarket oracle's cardinality
     ...
     * @param market EuphratesMarket address
     * @param duration twap duration
